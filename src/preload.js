...
const ipc = {
    'render': {
        ...
        'sendReceive': ['CHECK_API_KEY','GET_SETTINGS','DELETE_SETTINGS','SAVE_SETTINGS', 'LOADED','INV_READ_FILE', 'INV_GET_LANGUAGES', 'TRANSLATE', 'DEEPL_STATUS', 'GET_STATISTICS','RESET_STATS']
    }
};
